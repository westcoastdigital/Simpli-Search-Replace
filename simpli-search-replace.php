...
Description:  Serialised-safe database search & replace with preview functionality.
Version:      1.0.0
Author:       Jon Mather
...
define( 'SSR_VERSION', '1.0.0' );

require_once SSR_PATH . 'includes/class-ssr-serialiser.php';
